...
class AssetCache implements IAssetCache
{
	...
	**/
	...
	/**
		Internal
	**/
	@:noCompletion @:dox(hide) public var text:Map<String, String>;

	/**
		Internal
	**/
	@:noCompletion @:dox(hide) public var bytes:Map<String, ByteArray>;
	...
	**/
	public function new()
	{
		...
		bytes = new Map<String, ByteArray>();
	}
