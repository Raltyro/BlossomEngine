...
enum abstract RotationOrder(UInt8) {
	...
	public var x(get, set):UInt8;
	public var y(get, set):UInt8;
	public var z(get, set):UInt8;
	...
	inline function iterator():RotationOrderIterator return new RotationOrderIterator(this);
}
