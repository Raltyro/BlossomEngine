...
class ColumnInputManager implements IFlxDestroyable {
	...
	static inline function checkTyping():Bool return flixel.text.FlxInputText.globalManager.isTyping;
	static inline function convertKeyCode(input:KeyCode):FlxKey @:privateAccess return openfl.ui.Keyboard.__convertKeyCode(input);
